...
import org.bharatscan.imageprocessing.resizeForMaxPixels
...
fun jpegsForExport(
    ...
    return when (exportQuality) {
        ExportQuality.BALANCED -> pages.mapNotNull { page ->
...
fun encodeJpeg(mat: Mat, jpegQuality: Int): ByteArray? {
    return runCatching {
        org.bharatscan.imageprocessing.encodeJpeg(mat, jpegQuality)
    }.getOrNull()
}
