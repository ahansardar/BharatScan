...
android {
    ...
    defaultConfig {
        ...
        minSdk = 26
        targetSdk = 36
        versionCode = 63 // increment by 3 because of ABI-specific APKs
        versionName = "1.0.0"
    ...
    applicationVariants.all {
        ...
        variant.outputs
            ...
            .forEach { output ->
                ...
                output.outputFileName = "BharatScan-${variant.versionName}-${abi}.apk"
            }
    }
